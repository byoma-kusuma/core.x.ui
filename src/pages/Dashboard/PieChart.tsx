...
import { GetMemberByCentresQueryResponse } from "../../api/rest/reports";
...
const frequency = (d: GetMemberByCentresQueryResponse[0]) => d.memberCount;
...
export type PieProps = {
  ...
  animate?: boolean;
  data: GetMemberByCentresQueryResponse;
};
